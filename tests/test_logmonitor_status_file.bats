...
EOF
    echo "status:/tmp/test1.status" > "$TESTS_WORKDIR"/test1/source
...
EOF
    echo "status:/tmp/test1.status" > "$TESTS_WORKDIR"/test2/source
    echo "status:/tmp/test2.status" >> "$TESTS_WORKDIR"/test2/source
